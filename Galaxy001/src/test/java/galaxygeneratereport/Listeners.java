...
import galaxypageutilities.Galaxy_Extend_Report_Utility;
public class Listeners implements ITestListener {

	ExtentTest test;

	ExtentReports extent = Galaxy_Extend_Report_Utility.createExtentReports();
